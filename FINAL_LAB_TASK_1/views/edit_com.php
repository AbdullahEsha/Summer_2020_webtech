	...
	<form action="../php/userController.php" method="post">
		<fieldset>
			...
			<table>
				<tr>
					<td>Company Name</td>
					<td><input type="text" name="com_name" value="<?=$company['company_name']?>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Logo</td>
					<td><p><input type="file" name="logo"></td><img height="90px" src="<?=$company['company_logo']?>"></p>
				</tr>
				<tr>
					<td>Account ID</td>
					<td><input type="text" name="userid" value="<?=$company['user_account_id']?>"></td>
				</tr>
				<tr>
					<td></td>
					<td>
						<input type="hidden" name="id" value="<?=$company['id']?>">
						<input type="submit" name="edit_com" value="Update"> 
